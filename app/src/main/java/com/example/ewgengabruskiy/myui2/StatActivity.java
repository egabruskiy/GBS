...
public class StatActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    GeneralStatFragment generalStatFragment = new GeneralStatFragment();
                    return generalStatFragment;
                case 1:
                    DailyStatFragment dailyStatFragment= new DailyStatFragment();
                    return dailyStatFragment;
                default:
                    return null;
            }
        }
